            ...
            <div className="col-lg-8">
              <div className="portfolio-details-slider">
                <div className="swiper-wrapper align-items-center">
                  <StyledSwiper>
                    <SwiperSlide>
                        <img src="/img/gallery/lingpuz/DSCF2988.JPG" alt=""/>
                    </SwiperSlide>

                    <SwiperSlide>
                        <img src="/img/gallery/lingpuz/DSCF3410.JPG" alt=""/>
                    </SwiperSlide>

                    <SwiperSlide>
                        <img src="/img/gallery/lingpuz/DSCF3329.JPG" alt=""/>
                    </SwiperSlide>

                    <SwiperSlide>
                        <img src="/img/gallery/lingpuz/DSCF3360.JPG" alt=""/>
                    </SwiperSlide>

                    <SwiperSlide>
                        <img src="/img/gallery/lingpuz/DSCF2961.JPG" alt=""/>
                    </SwiperSlide>
                  </StyledSwiper>
                </div>
