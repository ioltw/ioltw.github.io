            ...
            <div className="col-lg-8">
              <div className="portfolio-details-slider">
                <div className="swiper-wrapper align-items-center">
                  <StyledSwiper>
                    <SwiperSlide>
                      <img src="/img/gallery/tutorialvideos/thumbnail22-1.png" alt=""/>
                    </SwiperSlide>
                    <SwiperSlide>
                      <img src="/img/gallery/tutorialvideos/thumbnail22.png" alt=""/>
                    </SwiperSlide>
                    <SwiperSlide>
                      <img src="/img/gallery/tutorialvideos/thumbnail21.png" alt=""/>
                    </SwiperSlide>
                  </StyledSwiper>
                </div>
