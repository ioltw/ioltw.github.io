            ...
            <div className="col-lg-8">
              <div className="portfolio-details-slider">
                <div className="swiper-wrapper align-items-center">
                  <StyledSwiper>
                    <SwiperSlide>
                      <img src="/img/gallery/iolnews/00347364.20230731274136785M.jpg" alt=""/>
                    </SwiperSlide>
                    <SwiperSlide>
                      <img src="/img/gallery/iolnews/3628693_1_1.jpg" alt=""/>
                    </SwiperSlide>
                    <SwiperSlide>
                      <img src="/img/gallery/iolnews/20210812004961.jpg" alt=""/>
                    </SwiperSlide>
                    <SwiperSlide>
                      <img src="/img/gallery/iolnews/20220801003932.jpg" alt=""/>
                    </SwiperSlide>
                  </StyledSwiper>
                </div>
