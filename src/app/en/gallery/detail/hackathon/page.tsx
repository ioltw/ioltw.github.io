              ...
              <div className="portfolio-details-slider">
                <div className="swiper-wrapper align-items-center">
                  <StyledSwiper>
                    <SwiperSlide>
                      <div>
                        <img src="/img/gallery/hackathon/19hack2.jpg" alt=""/>
                      </div>
                    </SwiperSlide>

                    <SwiperSlide>
                      <div>
                        <img src="/img/gallery/hackathon/19hack.jpg" alt=""/>
                      </div>
                    </SwiperSlide>

                    <SwiperSlide>
                      <div>
                        <img src="/img/gallery/hackathon/19hack1.jpg" alt=""/>
                      </div>
                    </SwiperSlide>

                    <SwiperSlide>
                      <div>
                        <img src="/img/gallery/hackathon/poster-19-long.png" alt=""/>
                      </div>
                    </SwiperSlide>
                  </StyledSwiper>
                </div>
