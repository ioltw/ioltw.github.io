      ...
      <div className="container">
		...
		<div className="row faq-item d-flex align-items-stretch">
		 ...
		 <div className="row faq-item d-flex align-items-stretch">
          <div className="col-lg-5">
            <i className='bx bxs-pin'></i>
            <h4><b>2026/05/19　2026 下半年活動日期預告 </b></h4>
          </div>
          <div className="col-lg-7">
            <p>
            <a href="/img/recent_attachments/2026-2event.png" target="_blank"><img src="/img/recent_attachments/2026-2event.png" alt="2026-2event" title="2026-2event" style={{width: "60%"}}/></a>
            </p>
          </div>
        </div>
 		...
 		<div className="row faq-item d-flex align-items-stretch">
          ...
          <div className="col-lg-7">
            <p>
              ...
              <br/>
			  中、英文試題、解答以及競賽成績統計資料已公布，歡迎前往官網「學生專區」中的「歷屆試題」查看。
			  <br/>
...
<div className="row faq-item d-flex align-items-stretch">
          ...
          <div className="col-lg-7">
            <p>
			  ...
			  <br/>
			  賽制更新：今年賽制重大調整，新增「高中推薦管道」及「選拔複賽」，相關細節請參閱簡章第四頁。
			  <br/>
			  考場地點：
			  <br/>
			  北部｜國立臺灣大學
  ...
  <div className="col-lg-7">
    <p>
      ...
      <br />
      本屆科展競爭格外激烈，來自全台各地的優秀選手帶來精彩的研究與創意發想，涵蓋語言學中的各式各樣的領域。評審老師表示，許多作品在研究方法、資料分析與展示表達上都展現了超越中學生水準的成熟度，令人印象深刻。
      <br />
