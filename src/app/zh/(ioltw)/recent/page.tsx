  ...
  return (
	...
	<div className="row faq-item d-flex align-items-stretch">
          ...
          <div className="col-lg-7">
            ...
            <p>
            <a href="public/img/recent_attachments/fb9f9b71-6921-423b-b83f-15609a9d58dd.jpg" target="_blank"><img src="public/img/recent_attachments/fb9f9b71-6921-423b-b83f-15609a9d58dd.jpg" alt="台灣語奧解題營時程表" title="台灣語奧解題營時程表" style={{width: "60%"}}/></a>
            </p>
          </div>
        </div>
